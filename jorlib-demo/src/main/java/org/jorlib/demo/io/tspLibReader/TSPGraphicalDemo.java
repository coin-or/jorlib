...
public class TSPGraphicalDemo {
	...
	public static void main(String[] args) throws IOException {
		TSPInstance problem = new TSPInstance(new File("./data/tspLib/tsp/gr120.tsp"));
		...
		panel.displayTour(Tour.createRandomTour(problem.getDimension()), new Color(128, 128, 128, 64)); //Random tour
