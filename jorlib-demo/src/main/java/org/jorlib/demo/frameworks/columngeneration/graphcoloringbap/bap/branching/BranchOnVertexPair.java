 ...
 * a pair of vertices, thereby creating two branches. In one branch, these vertices receive the same
 * color, whereas in the other branch they are colored differently
 * 
 * @author Joris Kinable
 * @version 29-6-2016
 */
public final class BranchOnVertexPair
    extends AbstractBranchCreator<ColoringGraph, IndependentSet, ChromaticNumberPricingProblem>
{
    ...
    {
        // Find a vertex v1 which is in BOTH independent set s1 and independent set s2, and a vertex
        // v2 which is ONLY in s1.
        int v1 = -1;
        int v2 = -1;
     ...
     */
    @Override
    protected List<BAPNode<ColoringGraph, IndependentSet>> getBranches(
        BAPNode<ColoringGraph, IndependentSet> parentNode)
    {
        // Branch 1: same color:
        SameColor branchingDecision1 = new SameColor(candidateVertexPair);
        BAPNode<ColoringGraph, IndependentSet> node2 = this.createBranch(
        ...
        BAPNode<ColoringGraph, IndependentSet> node1 = this.createBranch(
