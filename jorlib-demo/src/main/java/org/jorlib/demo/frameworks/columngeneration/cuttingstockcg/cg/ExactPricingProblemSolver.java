...
/**
 * This class provides a solver for the cutting stock pricing problem. The pricing problem is a
 * simple knapsack problem. Here we solve this problem through a simple MIP implementation.
 * 
 * @author Joris Kinable
 * @version 13-4-2015
 */
public final class ExactPricingProblemSolver
    extends AbstractPricingProblemSolver<CuttingStock, CuttingPattern, PricingProblem>
{
    ...
    @Override
    protected List<CuttingPattern> generateNewColumns()
            ...
            if (!cplex.solve() || cplex.getStatus() != IloCplex.Status.Optimal) {
                ...
                if (objective >= 1 + config.PRECISION) { // Generate new column if it has negative
                    ...
                    CuttingPattern column =
                        new CuttingPattern("exactPricing", false, pattern, pricingProblem);
