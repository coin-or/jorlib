...
public final class LiftedCoverInequalitySeparatorDemo
{
    ...
    public static void main(String[] args)
    {
        ...
        LiftedCoverInequalitySeparator separator =
            new LiftedCoverInequalitySeparator(knapsackAlgorithm);
        ...
        int b1 = 1500;
        System.out.println(
            "Knapsack constr: 774x_0 + 76x_1 + 22x_2 + 42x_3 + 21x_4 + 760x_5 + 818x_6 + 62x_7 + 785x_9 <= 1500");

        // Invoke the separator
        separator.separateMinimalCover(
            variableValues1.length, knapsackCoefficients1, b1, variableValues1);

        // First check whether a cover inequality exists. NOTE this is not a guarantee that there
        // exists a *violated* cover inequality!
        ...
        System.out.println(
            "Has violated Cover AbstractInequality: " + separator.isMinimalCoverViolated());
        // Get the minimal cover inequality:
        Set<Integer> coverSet = separator.getMinimalCover(); // Get the indices of the variables
                                                             // that occur in the cover
        // Print the cover inequality in a fancy way
        String coverLhs =
            coverSet.stream().map(i -> "x_" + i.toString()).collect(Collectors.joining(" + "));
        ...
        separator.separateLiftedCover(
            variableValues2.length, knapsackCoefficients2, b2, variableValues2, true);
        ...
        System.out
            .println("Has violated lifted cover inequality: " + separator.isLiftedCoverViolated());
