...
public final class SubtourSeparatorDemo
{
    ...
    {
        // Define a new Undirected Graph. For simplicity we'll use a simple, unweighted graph, but
        // in reality this class is mainly used
        // in combination with weighted graphs for TSP problems.
        Graph<Integer, DefaultEdge> undirectedGraph =
        ...
        SubtourSeparator<Integer, DefaultEdge> separator =
            new SubtourSeparator<Integer, DefaultEdge>(undirectedGraph);
        ...
        // The returned cut set is: {2,3,6}. This leads to the cut: \sum_{e\in \delta{2,3,6}} x_e
        // >=2
    }
    ...
    public static void example2()
    {
        ...
        // Invoke the separator
        SubtourSeparator<Integer, DefaultEdge> separator =
            new SubtourSeparator<Integer, DefaultEdge>(directedGraph);
        separator.separateSubtour(edgeValueMap);
