    ...
    implements Callable<Void>, BranchingDecisionListener
{
    ...
    /**
     * Boolean indicating whether the pricing problem could be solved. Certain branching decisions
     * may render the pricing problem infeasible
     **/
    ...
    /**
     * Solves the pricing problem. The method invokes generateNewColumns internally and stores the
     * generated columns in an internal list.
     * 
    ...
    /**
     * Generates one or more new columns with negative reduced cost. Every solver must implement
     * this method.
     * 
    ...
    /**
     * Set time limit (future point in time). A TimeLimitExceededException is thrown when this time
     * limit is exceeded.
     * 
    ...
    /**
     * Returns the cost of the most negative reduced cost column. If the pricing problem is an
     * maximization problem, then any feasible solution is a lower bound.
     * 
    ...
    /**
     * Returns a bound on the objective of the pricing problem. If the pricing problem is solved to
     * optimality, this function would typically return the objective value. Alternatively, the
     * objective value of a relaxation of the Pricing Problem may be returned, e.g. the LP
     * relaxation when the Pricing Problem is implemented as a MIP, or the value of a Lagrangian
     * Relaxation.
     * 
     ...
     * 
     * @return List of columns with negative reduced cost, or an empty list when no such column
     *         exists.
     */
    ...
    /**
     * Returns whether the pricing problem is feasible. For example due to branching decisions, no
     * feasible solution may exist for a particular pricing problem.
     * 
     * @return true if a feasible solution exists to the pricing problem, or false if there is none,
     *         or none could be found in case of a heuristic pricing solver.
     */
