...
public abstract class AbstractColumn<T, V extends AbstractPricingProblem<T>>
{
    ...
    public double value;
    /**
     * Indicates whether this is a real column generated by a pricing problem, or whether it has
     * been generated to obtain an initial feasible solution. Optimal solutions may NOT contain
     * artificial columns unless the problem is infeasible
     **/
