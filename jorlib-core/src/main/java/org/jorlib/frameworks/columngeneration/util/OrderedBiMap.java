...
/**
 * Bidirectional map. Contains several methods to get lists/arrays of the keys/values which allow
 * deterministic iteration ordering. This class is more flexible than Guava's {@code BiMap<K,V>} or
 * Oracle's {@code LinkedHashMap<K,V>}. The map cannot hold duplicate keys!
 * 
    ...
    extends AbstractMap<K, V>
{
    ...
    /**
     * Remove a key. Removing keys is relatively expensive O(n) time, where n is the number of items
     * in the list.
     * 
