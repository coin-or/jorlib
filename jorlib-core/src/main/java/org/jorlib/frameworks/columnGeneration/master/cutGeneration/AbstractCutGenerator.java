...
/**
 * This class is used to separate valid initialInequalities. It can access data from the the master problem through a
 * {@link MasterData} object. Each time initialInequalities have to be separated, the {@link #generateInqualities() generateInqualities} method is invoked. Given
 * the data from the master, the AbstractCutGenerator can then check whether there are any violated initialInequalities.
 * Typically, one wants to store any initialInequalities generated for a particular master problem in the corresponding MasterData object
 * such that the master problem has access to the initialInequalities.
 *
...
public abstract class AbstractCutGenerator<T extends ModelInterface, W extends MasterData> {
	 ...
	 * or the user may provide an initial set of initialInequalities.
	 * @param cut cut to be added
	 */
	public abstract void addCut(AbstractInequality cut);

	/**
	 * Returns all initialInequalities maintained by this generator
	 * @return list of initialInequalities maintained by the generator
	 */
