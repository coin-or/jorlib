 ...
 *
 */
public final class  PricingProblemSolverFactory<T,U extends Column<T,U>, V extends PricingProblem<T, U>> {
	...
	public PricingProblemSolverFactory(Class<? extends PricingProblemSolver<T, U, V>> solverClass, String solverName, T dataModel){
