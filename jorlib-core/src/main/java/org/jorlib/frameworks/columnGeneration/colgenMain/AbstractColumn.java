 ...
 *
 */
public abstract class AbstractColumn<T, U extends AbstractColumn<T,U,V>, V extends AbstractPricingProblem<T>>/*<T, V extends PricingProblem<T, C>, C extends Column<T,V, C>> */{
