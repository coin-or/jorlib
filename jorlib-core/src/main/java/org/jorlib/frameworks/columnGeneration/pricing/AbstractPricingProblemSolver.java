...
public abstract class AbstractPricingProblemSolver<T,U extends AbstractColumn<T, V>, V extends AbstractPricingProblem<T>> implements Callable<Void>, BranchingDecisionListener{
	...
	/**
	 * This method is invoked directly *before* the generatenewColumns() method is solved. It allows the user to update the pricing solver with fresh
	 ...
	 * @return List of columns with negative reduced cost, or an empty list of no such column exists.
	 */
