...
public abstract class AbstractPricingProblemSolver<T,U extends AbstractColumn<T, V>, V extends AbstractPricingProblem<T>> implements Callable<Void>, BranchingDecisionListener{
	...
	/**
	 * Solves the pricing problem. The method invokes generateNewColumns internally and stores the generated initialColumns in an internal
	 * list.
	...
	/**
	 * Generates one or more new initialColumns with negative reduced cost. Every solver must implement this method.
	 * @return List of initialColumns with negative reduced cost
	...
	/**
	 * Returns the list of negative reduced cost initialColumns generated by the solver
	 * @return List of initialColumns with negative reduced cost, or an empty list when no such column exists.
	 */
