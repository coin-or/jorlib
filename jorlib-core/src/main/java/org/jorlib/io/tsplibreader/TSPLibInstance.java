...
public class TSPLibInstance
{
    ...
    /**
     * The format of the edge weight matrix when explicit weights are used; or {@code null} if edge
     * weights are not explicit.
     */
    ...
    /**
     * The data used to graphically display the nodes; or {@code null} if the display data is not
     * explicitly defined.
     */
    ...
    /**
     * The demands and depot nodes for vehicle routing problems; or {@code null} if this is not a
     ...
     */
    public TSPLibInstance(File file)
        throws IOException
    {
        this();
     ...
     * @throws IOException if an I/O error occurred while loading the TSPLIB file
     */
    public TSPLibInstance(InputStream inputStream)
        throws IOException
    {
        this();
        ...
        try {
            while ((line = reader.readLine()) != null) {
                ...
                if (line.equals("NODE_COORD_SECTION")) {
                    ...
                    || line.matches("^\\s*FIXED_EDGES\\s*\\:\\s*$"))
                {
    ...
    /**
     * Adds a solution to this TSPLIB problem instance. This method does not verify that the
     * solution has all required edges; the caller must ensure this condition holds.
     * 
    ...
    /**
     * Adds a solution to this TSPLIB problem instance that is defined in a separate file. This
     * method does not verify that the solution is a valid tour for this problem instance; the
     * caller must ensure this condition holds.
     * 
     ...
     * @throws IOException if an I/O error occurred while loading the tour
     */
    public void addTour(InputStream inputStream)
        throws IOException
    {
        TSPLibInstance problem = new TSPLibInstance();
        BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream));
    ...
    /**
     * Returns the truck capacity in CVRP problem instances. The return value is undefined if the
     * data type is not {@code CVRP}.
     * 
    ...
    /**
     * Returns the format of the edge weight matrix when explicit weights are used; or {@code null}
     * if edge weights are not explicit.
     * 
     * @return the format of the edge weight matrix when explicit weights are used; or {@code null}
     *         if edge weights are not explicit
     */
    ...
    /**
     * Returns the distance table that defines the nodes, edges, and weights for this problem
     * instance.
     * 
     * @return the distance table that defines the nodes, edges, and weights for this problem
     *         instance
     */
    ...
    /**
     * Returns the data used to graphically display the nodes; or {@code null} if the display data
     * is not explicitly defined.
     * 
     * @return the data used to graphically display the nodes; or {@code null} if the display data
     *         is not explicitly defined
     */
    ...
    /**
     * Returns the demands and depot nodes for vehicle routing problems; or {@code null} if this is
     * not a vehicle routing problem instance.
     * 
     * @return the demands and depot nodes for vehicle routing problems; or {@code null} if this is
     *         not a vehicle routing problem instance
     */
