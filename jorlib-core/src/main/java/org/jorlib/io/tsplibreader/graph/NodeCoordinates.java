    ...
    extends DistanceTable
{
    ...
    {
        this(size, edgeWeightType.getNodeCoordType(), edgeWeightType.getDistanceFunction());
    }
    ...
    /**
     * Adds the specified node to this problem instance. If a node with the same identifier already
     * exists, the previous node will be replaced.
     * 
