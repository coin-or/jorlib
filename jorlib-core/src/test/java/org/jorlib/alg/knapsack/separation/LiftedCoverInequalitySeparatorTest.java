 ...
 * 
 */
public final class LiftedCoverInequalitySeparatorTest
    extends TestCase
{
    ...
    public void testSeparateMinimalCoverInequality1()
    {
        ...
        int b1 = 1500;
        separator.separateMinimalCover(
            variableValues1.length, knapsackCoefficients1, b1, variableValues1);

        assertTrue(separator.coverInequalityExists());
        assertTrue(separator.isMinimalCoverViolated());
        Assert.assertArrayEquals(
            new boolean[] { true, false, false, false, false, false, true, false, false },
            separator.getMinimalCoverMask());
    ...
    public void testSeparateMinimalCoverInequality2()
    {
        ...
        int b2 = 1500;
        separator.separateMinimalCover(
            variableValues2.length, knapsackCoefficients2, b2, variableValues2);

        assertTrue(separator.coverInequalityExists());
        assertTrue(separator.isMinimalCoverViolated());
        Assert.assertArrayEquals(
            new boolean[] { false, false, true, false, false, false, true, false, false },
            separator.getMinimalCoverMask());
    ...
    public void testSeparateMinimalCoverInequality3()
    {
        ...
        int b3 = 178;
        separator.separateMinimalCover(
            variableValues3.length, knapsackCoefficients3, b3, variableValues3);

        assertTrue(separator.coverInequalityExists());
        assertTrue(separator.isMinimalCoverViolated());
        Assert.assertArrayEquals(
            new boolean[] { false, false, true, true, true }, separator.getMinimalCoverMask());
    ...
    public void testSeparateMinimalCoverInequality4()
    {
        ...
        int b4 = 178;
        separator.separateMinimalCover(
            variableValues4.length, knapsackCoefficients4, b4, variableValues4);
    ...
    /**
     * Test 5 - violated minimal cover: {@code x1+x7<=1}, violated lifted cover:
     * {@code x1+x6+x7+x9<=1}
     */
    public void testSeparateLiftedCoverInequality1()
    {
        ...
        int b5 = 1500;
        separator.separateLiftedCover(
            variableValues5.length, knapsackCoefficients5, b5, variableValues5, true);
        ...
        Assert.assertArrayEquals(
            new int[] { 1, 0, 0, 0, 0, 1, 1, 0, 1 }, separator.getLiftedCoverCoefficients());
        assertEquals(1, separator.getLiftedCoverRHS());
        assertEquals(1.71, separator.getLiftedCoverLHS(), 0.000001);
    }

    /**
     * Test 6 - minimal cover: {@code x3+x4+x5<=2} (NOT violated), violated lifted cover:
     * {@code x1+2x3+x4+x5<=3}
     */
    public void testSeparateLiftedCoverInequality2()
    {
        ...
        int b6 = 178;
        separator.separateLiftedCover(
            variableValues6.length, knapsackCoefficients6, b6, variableValues6, true);
        ...
        assertTrue(separator.isLiftedCoverViolated());
        Assert
            .assertArrayEquals(new int[] { 1, 0, 2, 1, 1 }, separator.getLiftedCoverCoefficients());
        assertEquals(3, separator.getLiftedCoverRHS());
        assertEquals(3.5, separator.getLiftedCoverLHS(), 0.000001);
    }

    /**
     * Test 7 - Knapsack: {@code 3x_1+3_x_2 <=6}. NO cover inequality exists for this knapsack
     * constraint.
     */
    public void testNoCoverInequalityExists()
    {
        ...
        int b7 = 6;
        separator.separateLiftedCover(
            variableValues7.length, knapsackCoefficients7, b7, variableValues7, true);
