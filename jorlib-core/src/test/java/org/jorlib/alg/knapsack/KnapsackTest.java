    ...
    extends TestCase
{
    ...
    public void testKnapsack1()
    {
        ...
        knapsack
            .solveKnapsackProblem(itemValues.length, maxKnapsackWeight, itemValues, itemWeights);
        assertEquals(8, knapsack.getKnapsackWeight());
        assertEquals(29, knapsack.getKnapsackValue(), 0.000001);
        Assert.assertArrayEquals(
            new boolean[] { true, false, true, true }, knapsack.getKnapsackItems());
    }
    ...
    public void testKnapsack2()
    {
        ...
        Assert.assertArrayEquals(
            new boolean[] { false, true, true, false, true }, knapsack.getKnapsackItems());
    }
}
