 ...
 */
/* -----------------
 * BestBoundBapNodeComparatorTest.java
 * -----------------
 * (C) Copyright 2016, by Joris Kinable and Contributors.
 *
...
public final class BestBoundBapNodeComparatorTest {
    ...
    public void testBestBoundMinimization(){
        ...
        BestBoundBapNodeComparator comparator=new BestBoundBapNodeComparator(OptimizationSense.MINIMIZE);
    ...
    public void testBestBoundMaximization(){
        ...
        BestBoundBapNodeComparator comparator=new BestBoundBapNodeComparator(OptimizationSense.MAXIMIZE);
