...
public final class DFSBapNodeComparatorTest
{
    ...
    @Test
    public <T extends ModelInterface, U extends AbstractColumn<T,? extends AbstractPricingProblem<T, U>>> void testDFSNodeComparator()
    {
        ...
        DFSBapNodeComparator<T,U> comparator = new DFSBapNodeComparator<>();
